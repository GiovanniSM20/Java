...
public class JanelasDeConfirmacao {
	public static void main(String[] args) {
		...
		case JOptionPane.NO_OPTION:
			...
			"Título da Janela de Confirmação 2", JOptionPane.OK_CANCEL_OPTION);
			...
			int opt3 = JOptionPane.showConfirmDialog(null, "Janela de Confirmação 3",
					"Título da Janela de Confirmação 3", JOptionPane.YES_NO_OPTION, JOptionPane.ERROR_MESSAGE);
					...
					ImageIcon iconFoto = new ImageIcon("img/imprimir.png");
					int opt4 = JOptionPane.showConfirmDialog(null, "Janela de Confirmação 4",
							"Título da Janela de Confirmação 4", JOptionPane.YES_NO_CANCEL_OPTION, JOptionPane.PLAIN_MESSAGE, iconFoto);
