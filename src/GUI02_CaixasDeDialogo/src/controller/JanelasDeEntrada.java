...
public class JanelasDeEntrada {
	public static void main(String[] args){
		...
		ImageIcon iconFoto = new ImageIcon("img/images.png");
		String[] vetString = {"Fabrício", "Rodrigo", "Xicão", "PC"};
		Object objeto = JOptionPane.showInputDialog(null, "Janela de Entrada 6", 
				"Título da janela de entrada 6", JOptionPane.PLAIN_MESSAGE, 
				iconFoto, vetString, vetString[3]);
